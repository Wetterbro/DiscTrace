const Contact = () => {
    return (
        <div className="relative flex items-top justify-center min-h-screen bg-white dark:bg-gray-900 sm:pt-0">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2">
                    ...
                    <form className="p-6 flex flex-col justify-center">
                        ...
                        <div className="flex flex-col mt-2">
                            ...
                            <input type="tel" name="tel" id="tel" placeholder="Phone Number" className="w-100 mt-2 py-3 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 font-semibold focus:border-indigo-500 focus:outline-none"/>
                        </div>
